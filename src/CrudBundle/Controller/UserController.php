...
use CrudBundle\Form\UserType;
use CrudBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('CrudBundle:User')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("CrudBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CrudBundle:User')->find($id);
     ...
     * @Method("PUT")
     * @Template("CrudBundle:User:edit.html.twig")
     */
